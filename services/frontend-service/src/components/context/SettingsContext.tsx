...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [coordinates, setCoordinates] = useState({ longitude: -101.87457, latitude: 33.58462 });
  ...
  return (
    <SettingsContext.Provider value={{ coordinates, setCoordinates, mapStyle, setMapStyle, borderOpacity, setBorderOpacity, fillOpacity, setFillOpacity }}>
      {children}
